...
- control relay via [Telegram messenger](https://github.com/enjoyneering/tthRelay/blob/main/images/telegram_bot.jpg) with default update rate of 10 seconds (can be configured via html page), up to 20 relay bots in one group chat
...
[version]:       https://img.shields.io/badge/Version-4.0.7-green.svg
